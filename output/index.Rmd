...
alderman_contributions %>% 
  ...
  ggplot() +
  geom_boxplot(aes(reorder(ALDERMAN, sum), AMOUNT), alpha = 0.8, median.type = "line", hoffset = 0, width = 2) + 
  coord_flip() +
...
ggplot(sample_df, aes(x = parameter, y = values)) + 
  geom_boxplot(median.type = "line", hoffset = 0, width = 2) + 
