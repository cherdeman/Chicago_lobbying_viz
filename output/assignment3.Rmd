...
ggplot +
  ...
  labs(title="Real estate developments are the most frequently discussed items in lobbying meetings",
...
The lobbyists paid the most compensation by the top 20 firms appear to have a strategy of blanket, moderate, financial support for almost all aldermen. One notable exception is John Kelly, President and Owner of the public affairs consulting firm [All-Circo, Inc](http://www.allcirco.com/). TODO ADD ADDITIONAL COMMENTARY 

Two of the eight attorneys paid over $1M, Amy Kurson and Victor Reyes, are both partners at the lawfirm Reyes Kurson. Their contribution data was not included in the data protal contribution records, so records were added from IllinoisSunshine.com
