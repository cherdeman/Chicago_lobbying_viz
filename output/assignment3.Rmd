...
ggplot +
  ...
  geom_text_repel(segment.size = 0, force = 200) +
...
short_industry <- c("REAL ESTATE", "TECH", "RESTAURANTS",
...
compensation %>% 
  ...
  ggplot(aes(y = sum, axis1 = CLIENT_INDUSTRY, axis2 = LAWFIRM)) +
    ...
    labs(title="Though real estate related lobbying activities are most common, \ndevelopers aren't among the top 20 clients",
         subtitle="Compensation Flow Between Industries and Lawfirms, 2015-2018",
         caption="Source: City of Chicago Lobbyist Data, Comepnsation",
